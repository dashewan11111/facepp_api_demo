...
public class FaceSetAddFaceAsyncPresenter extends BaseActionPresenter<FaceSetAddFaceFragmentAsync> {

    @Override
    public void doAction(Object... params) {
        faceppApi.facesetAddFaceAsync((Map<String, String>) params[0], new IFacePPCallBack<FaceSetAddResponse>() {
            @Override
