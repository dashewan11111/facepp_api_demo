...
import com.megvii.ui.presenter.FaceSetRemoveFaceAsyncPresenter;
...
public class FaceSetRemoveFaceFragmentAsync extends BaseActionFragment<FaceSetRemoveFaceAsyncPresenter> implements FaceTokenListAdapter.OnItemClickListener {
    ...
    public void onGetFaceTokensSuccess(final List<String> faceTokenList) {
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                adapter.setItemClickListener(FaceSetRemoveFaceFragmentAsync.this);
                recyclerView.setAdapter(adapter);
            }
        });
    }
    ...
    @Override
    public FaceSetRemoveFaceAsyncPresenter newP() {
        return new FaceSetRemoveFaceAsyncPresenter();
    }
