...
import com.megvii.ui.presenter.FaceGetDetailPresenter;
...
public class FaceGetDetailFragment extends BaseActionFragment<FaceGetDetailPresenter> {
    ...
    public void initData(Bundle savedInstanceState) {
        ...
        adapter = new ParametersAdapter(context, ParametersConstant.FACE_GET_DETAIL, getArguments());
    ...
    public void onSuccess(Object... response) {
        ...
        final FaceDetailResponse response1 = (FaceDetailResponse) response[0];
    ...
    public void onDetectSuccess(final String faceTokens) {
        ...
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                adapter = new ParametersAdapter(context, ParametersConstant.FACE_GET_DETAIL, bundle);
                recyclerView.setAdapter(adapter);
            }
        });
    }
    ...
    @Override
    public FaceGetDetailPresenter newP() {
        return new FaceGetDetailPresenter();
    }
